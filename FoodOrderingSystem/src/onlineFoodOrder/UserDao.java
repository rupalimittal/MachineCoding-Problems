...
public class UserDao {
    ...
    public User registerUser(Long phone, String name, Long pinCode, Gender gender) {
        ...
        if (phoneNumberMap.containsKey(phone)) {
            ...
            System.out.println("onlineFoodOrder.User already exist with phone number " + phone + " with user id : " + user.getId()+"\n");
            return user;
        }
    ...
    public Restaurant registerRestaurant(String name, String pinCodes, String item, int price, int quantity) {
        ...
        if (restaurantNameMap.containsKey(name)) {
            System.out.println("onlineFoodOrder.Restaurant already exist with given name, please give unique name\n");
            return null;
        }
    ...
    public List<Restaurant> showRestaurant(String sortBy) {
        ...
        if(sortBy.equalsIgnoreCase("rating")){
            ...
            for(Restaurant restaurant: restaurants){
                System.out.println("onlineFoodOrder.Restaurant id :"+restaurant.getId()+ ": name-> "+
    ...
    public Orders placeOrder(String name, Integer quantity) {
        ...
        if(restaurant.getQuantity()<quantity){
            System.out.println("onlineFoodOrder.Restaurant has only" + restaurant.getQuantity()+" Items, please check your cart");
            return null;
        }
    ...
    public List<Orders> listOrders() {
        for(Orders order: loggedInUser.getOrders()){
