...
public class Splitwise {
	public static void main(String[] args) {
		...
		expenseManager.addUser(new User("1", "rupali mittal", "mittalruapli@outlook.com", "8133910729"));
		expenseManager.addUser(new User("2", "papa", "papa@gmail.com", "0000999909"));
		expenseManager.addUser(new User("3", "mammi", "mammi.ska23@gmail.com", "7123123123"));
		expenseManager.addUser(new User("4", "shubham", "shubham@outlook.com", "8133910729"));
		expenseManager.addUser(new User("5", "mamaji", "mamaji@al.com", "1231231232"));
		expenseManager.addUser(new User("6", "mamiji", "mamiji@s.com", "1212121212"));
		expenseManager.addUser(new User("7", "doggi", "doggi@d.com", "4747474747"));
